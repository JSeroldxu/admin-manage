<template>
  <div class="authentication-wrapper authentication-3">
    <div class="authentication-inner">
      ...
      <div class="d-none d-lg-flex col-lg-8 align-items-center ui-bg-cover ui-bg-overlay-container p-5" style="background-image: url('/static/img/21.jpg');">
        <div class="ui-bg-overlay bg-dark opacity-50"></div>

        <!-- Text -->
        <div class="w-100 text-white px-5">
          <h1 class="display-1 font-weight-bolder mb-4">JOIN OUR SYSTEM</h1>
          ...
          <div class="w-100">
            ...
            <form class="my-5">
              ...
              <div class="d-flex justify-content-between align-items-center m-0">
                ...
                <b-btn variant="primary" @click="Login()">登录</b-btn>
              </div>
            </form>
            <!-- / Form -->
...
<script>
  export default {
    ...
    methods:{
      Login(){
        this.$router.push({name:'indexStatistics'})
        // this.$api.admin.login(data=>{
        //   window.sessionStorage.setItem('card.token',data.token)
